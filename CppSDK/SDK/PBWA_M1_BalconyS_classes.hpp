...
static_assert(alignof(APBWA_M1_BalconyS_C) == 0x000004, "Wrong alignment on APBWA_M1_BalconyS_C");
static_assert(sizeof(APBWA_M1_BalconyS_C) == 0x000948, "Wrong size on APBWA_M1_BalconyS_C");
