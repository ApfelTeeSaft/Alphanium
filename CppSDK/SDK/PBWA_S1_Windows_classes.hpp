...
static_assert(alignof(APBWA_S1_Windows_C) == 0x000004, "Wrong alignment on APBWA_S1_Windows_C");
static_assert(sizeof(APBWA_S1_Windows_C) == 0x0009F0, "Wrong size on APBWA_S1_Windows_C");
