...
static_assert(alignof(APBWA_M1_ArchwayLarge_C) == 0x000004, "Wrong alignment on APBWA_M1_ArchwayLarge_C");
static_assert(sizeof(APBWA_M1_ArchwayLarge_C) == 0x0009F0, "Wrong size on APBWA_M1_ArchwayLarge_C");
