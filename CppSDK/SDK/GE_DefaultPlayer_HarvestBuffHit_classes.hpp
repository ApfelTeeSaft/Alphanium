...
static_assert(alignof(UGE_DefaultPlayer_HarvestBuffHit_C) == 0x000004, "Wrong alignment on UGE_DefaultPlayer_HarvestBuffHit_C");
static_assert(sizeof(UGE_DefaultPlayer_HarvestBuffHit_C) == 0x000368, "Wrong size on UGE_DefaultPlayer_HarvestBuffHit_C");
