...
static_assert(alignof(APBWA_M1_StairR_C) == 0x000004, "Wrong alignment on APBWA_M1_StairR_C");
static_assert(sizeof(APBWA_M1_StairR_C) == 0x00094C, "Wrong size on APBWA_M1_StairR_C");
