...
class AFactory_Trim_10a_C final : public ABuildingPropWall
{
public:
...
static_assert(alignof(AFactory_Trim_10a_C) == 0x000004, "Wrong alignment on AFactory_Trim_10a_C");
static_assert(sizeof(AFactory_Trim_10a_C) == 0x00094C, "Wrong size on AFactory_Trim_10a_C");
