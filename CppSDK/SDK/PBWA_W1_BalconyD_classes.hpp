...
static_assert(alignof(APBWA_W1_BalconyD_C) == 0x000004, "Wrong alignment on APBWA_W1_BalconyD_C");
static_assert(sizeof(APBWA_W1_BalconyD_C) == 0x000948, "Wrong size on APBWA_W1_BalconyD_C");
