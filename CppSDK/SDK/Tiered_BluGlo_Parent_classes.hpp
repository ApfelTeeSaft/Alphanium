...
static_assert(alignof(ATiered_BluGlo_Parent_C) == 0x000004, "Wrong alignment on ATiered_BluGlo_Parent_C");
static_assert(sizeof(ATiered_BluGlo_Parent_C) == 0x000A7C, "Wrong size on ATiered_BluGlo_Parent_C");
