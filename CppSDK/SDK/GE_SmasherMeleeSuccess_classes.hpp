...
static_assert(alignof(UGE_SmasherMeleeSuccess_C) == 0x000004, "Wrong alignment on UGE_SmasherMeleeSuccess_C");
static_assert(sizeof(UGE_SmasherMeleeSuccess_C) == 0x000368, "Wrong size on UGE_SmasherMeleeSuccess_C");
