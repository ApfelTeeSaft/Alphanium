...
class AFactory_Wall_13_C final : public ABuildingWall
{
public:
...
static_assert(alignof(AFactory_Wall_13_C) == 0x000004, "Wrong alignment on AFactory_Wall_13_C");
static_assert(sizeof(AFactory_Wall_13_C) == 0x0009F0, "Wrong size on AFactory_Wall_13_C");
