...
class ACar_Rat_C final : public ACar_Copper_C
{
public:
...
static_assert(alignof(ACar_Rat_C) == 0x000004, "Wrong alignment on ACar_Rat_C");
static_assert(sizeof(ACar_Rat_C) == 0x000A20, "Wrong size on ACar_Rat_C");
