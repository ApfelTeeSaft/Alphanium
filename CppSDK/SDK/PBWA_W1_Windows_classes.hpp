...
static_assert(alignof(APBWA_W1_Windows_C) == 0x000004, "Wrong alignment on APBWA_W1_Windows_C");
static_assert(sizeof(APBWA_W1_Windows_C) == 0x0009F0, "Wrong size on APBWA_W1_Windows_C");
