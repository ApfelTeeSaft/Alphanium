...
static_assert(alignof(UGA_Trap_FloorSpikes_C) == 0x000004, "Wrong alignment on UGA_Trap_FloorSpikes_C");
static_assert(sizeof(UGA_Trap_FloorSpikes_C) == 0x0006F4, "Wrong size on UGA_Trap_FloorSpikes_C");
