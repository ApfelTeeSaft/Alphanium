...
class UGE_Trap_WallElectric_C final : public UGameplayEffect
{
public:
...
static_assert(alignof(UGE_Trap_WallElectric_C) == 0x000004, "Wrong alignment on UGE_Trap_WallElectric_C");
static_assert(sizeof(UGE_Trap_WallElectric_C) == 0x000368, "Wrong size on UGE_Trap_WallElectric_C");
