...
static_assert(alignof(AB_Rifle_Generic_C) == 0x000004, "Wrong alignment on AB_Rifle_Generic_C");
static_assert(sizeof(AB_Rifle_Generic_C) == 0x000774, "Wrong size on AB_Rifle_Generic_C");
