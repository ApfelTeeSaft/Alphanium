...
// Parameters:
// const struct FVector&                   StartLocation_0                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
// float                                   AnimDelay                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
void ABluGlo_Node_C::BlueprintHandleMissionEventNoReply(const struct FFortMissionEvent& MissionEvent)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BluGlo_Node_C", "BlueprintHandleMissionEventNoReply");

	Params::BluGlo_Node_C_BlueprintHandleMissionEventNoReply Parms{};
