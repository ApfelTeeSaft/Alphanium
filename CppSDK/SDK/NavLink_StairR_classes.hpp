...
static_assert(alignof(UNavLink_StairR_C) == 0x000004, "Wrong alignment on UNavLink_StairR_C");
static_assert(sizeof(UNavLink_StairR_C) == 0x00005C, "Wrong size on UNavLink_StairR_C");
