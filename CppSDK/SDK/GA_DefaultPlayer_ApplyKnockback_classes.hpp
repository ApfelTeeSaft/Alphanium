...
static_assert(alignof(UGA_DefaultPlayer_ApplyKnockback_C) == 0x000004, "Wrong alignment on UGA_DefaultPlayer_ApplyKnockback_C");
static_assert(sizeof(UGA_DefaultPlayer_ApplyKnockback_C) == 0x000748, "Wrong size on UGA_DefaultPlayer_ApplyKnockback_C");
