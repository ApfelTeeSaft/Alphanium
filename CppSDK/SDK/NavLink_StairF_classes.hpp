...
static_assert(alignof(UNavLink_StairF_C) == 0x000004, "Wrong alignment on UNavLink_StairF_C");
static_assert(sizeof(UNavLink_StairF_C) == 0x00005C, "Wrong size on UNavLink_StairF_C");
