...
static_assert(alignof(APBWA_S1_BalconyD_C) == 0x000004, "Wrong alignment on APBWA_S1_BalconyD_C");
static_assert(sizeof(APBWA_S1_BalconyD_C) == 0x000948, "Wrong size on APBWA_S1_BalconyD_C");
